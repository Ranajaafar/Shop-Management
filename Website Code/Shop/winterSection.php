...
<body>
    <div class="container">
        ...
        <main id="main">
            <div class=title>
                <h1 id="title">WINTER COLLECTION</h1>
            </div>

            <?php 
                // import all the products in winter collection
                $sql = "SELECT pid,pname,pimg,price, description From dbo.on_stock WHERE cat_id=100";
                ...
                <div class="productInfo">
                    ...
                    <div class="CART">
                        <div class="quantity">
                            ...
                            <?php 
                                //CALLING A FUNCTION TO KNOW THE QUANTITY OF EACH PRODUCTS IN THE STOCK
                                $id = $row["pid"];
